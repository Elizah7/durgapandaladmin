...
const rootReducer = combineReducers({ postvideosreducer,get_valid_user_reducer, forgot_pass_reducer, enter_new_password_reducer, postImagesReducer, Loginreducer, usersignupreducer, getImageDatareducer, ImageUploadreducer, getsingleuserreducer });
